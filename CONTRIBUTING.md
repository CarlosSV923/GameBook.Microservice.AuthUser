...
- Feature branches use `feature/[task-number]/[summary]`, for example `feature/004-01/initialize-auth-user`.
...
- Do not include secrets, tokens, passwords, private keys, or real API keys.
